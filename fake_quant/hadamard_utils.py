...
def get_hadK(n, transpose=False):
    hadK, K = None, None
    if n % 296 == 0:  # Qwen2.5 7B
        assert (is_pow2(n // 296))
        K = 296
        hadK = get_had296().T if transpose else get_had296()
    ...
    elif n % 124 == 0:  # falcon 180b
        assert (is_pow2(n // 124))
        K = 124
        hadK = get_had124().T if transpose else get_had124()
    elif n % 116 == 0:  # falcon 180b
        assert (is_pow2(n // 116))
        K = 116
        hadK = get_had116().T if transpose else get_had116()
    elif n % 112 == 0:  # Qwen2.5-7B
        assert (is_pow2(n // 112))
        K = 112
        hadK = get_had112().T if transpose else get_had112()
        ...
        assert (is_pow2(n)), f'Unsupported size {n}'
        K = 1
...
# # had60.pal, had108.pal, had112.ttwill, had140.pal, had156.will, had172.will:
